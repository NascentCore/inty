<!--YOU DO NOT EDIT THIS FILE, HUMANS DO!-->

# Inty (Intelligent Entity) monorepo: AI agentic harness and systems for long-term emotional companionship

Inty is an agentic AI system to simulate human-like intelligent being,
with emotional behaviors as its utmost focus.

The whole system is oriented towards elicit human-like emotional behaviors from LLMs,
which in turn arouses emotional responses from human users, cultivate long-term emotional bonding between the user and AI.

The ultimate goal is to build life-long companion for humans. Starting from mature adults users.
