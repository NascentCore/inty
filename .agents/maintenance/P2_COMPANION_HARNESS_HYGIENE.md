...
## 2026-09-04 scan (cron)

Source: open PR overlap check (#3869..#3916 claim HYGIENE-2026-182..325 scope-accessor / google_web_search / audit-delete batches; #3834 TrackSystemRecipe, #3837 user simulator — no overlap); ruff UP017/UP035/UP041/F401/F841 + vulture `--min-confidence 80` clean on `app/core/companion_harness/` + tests; `google_web_search` import regression still blocks harness pytest collection on `main`; `companion_tool_definitions.py` JSONL tool descriptions still import `*_JSONL_REL` directly.

Open PRs checked: #3869..#3916 (maintenance scope-accessor + collection-fix lane), #3834, #3837, #3882 (compose_context dead bridge) — HYGIENE-2026-182..325 claimed; tasks below are new 326+ lane.
