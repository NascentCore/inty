...
## 2026-09-03 scan (cron)

Source: open PR overlap check (#3869..#3914 claim HYGIENE-2026-182..322 path-constant / scope-accessor batches; #3834 TrackSystemRecipe, #3837 user simulator — no overlap); ruff UP017/UP035/UP041/F401/F841 + vulture `--min-confidence 80` clean on `app/core/companion_harness/` + tests; `google_web_search` import regression still blocks harness pytest collection on `main`.

Open PRs checked: #3869..#3914 (maintenance scope-accessor lane), #3834, #3837 — HYGIENE-2026-182..322 claimed; tasks below are new 323+ lane.
