...
- [ ] **HYGIENE-2026-05** `claimed:cursor/agent-maintenance-tasks-f49a` ruff UP017: remaining `timezone.utc` in `agentic_companion/output_queue.py`, `agentic_companion/postgres_queue.py`, `companion/dreaming.py`, `companion/proactive_chat.py`, `companion/schedule_queue.py`, `runtime/dreaming_batch.py`, `tools/fal_z_image_tool.py`.
- [ ] **HYGIENE-2026-06** `claimed:cursor/agent-maintenance-tasks-f49a` ruff UP017: test files still using `timezone.utc` instead of `datetime.UTC` (batch by test subdir).
