...
## 2026-09-13 scan (cron)

Source: open PR overlap check (#3930 HYGIENE-359..363, #3932 HYGIENE-364..370, #3935 HYGIENE-371..376 — core MemDoc MD kinds below not claimed); ruff UP017/UP035/UP041/F401/F841 + vulture `--min-confidence 80` clean; `google_web_search.py` still imports missing `app.utils.simple_http` (pytest collection blocker).

Open PRs checked: #3930 (`cursor/agent-maintenance-tasks-a648`), #3932 (`cursor/agent-maintenance-tasks-7def`), #3935 (`cursor/agent-maintenance-tasks-21bc`) — no overlap with tasks below.
