...
## 2026-09-22 scan (cron)

Source: open PR overlap check (HYGIENE-2026-405..420 claimed on open maintenance PRs #3952–#3961); ruff UP017/UP035/UP041/F401/F841 + vulture `--min-confidence 80` clean; follow-up — production modules still read/append MemDoc paths via `*_REL` constants instead of `DEFAULT_MEMORY_STORE_SCOPE_PATHS` accessors.

Open PRs checked: #3952 (`HYGIENE-2026-405..407`), #3955 (`408..411`), #3958 (`412..415`), #3961 (`417..420`) — no overlap with tasks below.
