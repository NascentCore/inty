...
## 2026-08-22 scan (cron)

Source: open PR overlap check (#3834 Phase 2 TrackSystemRecipe, #3837 long-term user simulator, #3870–#3893 scope-path accessor batches — no overlap); ruff UP017/UP035/UP041/F401/F841 + vulture `--min-confidence 80` clean; #3413 follow-up — remaining harness tests still seed/read MemDoc paths via `memory_store_path_constants` imports instead of `MemoryStoreScopePaths` accessors.

Open PRs checked: #3834, #3837, #3870–#3893 (HYGIENE-2026-182..268 claimed) — no overlap with tasks below.
