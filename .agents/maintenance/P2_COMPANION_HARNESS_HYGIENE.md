...
## 2026-08-27 scan (cron)

Source: open PR overlap check (#3834 Phase 2 TrackSystemRecipe, #3837 long-term user simulator, #3900..#3905 scope-accessor batches — no overlap); ruff UP017/UP035/UP041/F401/F841 + vulture `--min-confidence 80` clean; follow-up — `memory_store_document_mapping._REL_TO_KIND` still duplicates path constants; schedule/runtime-event tests lack scope-path smoke assertions.

Open PRs checked: #3834 (`cursor/phase-2-tracksystemrecipe-b95a`), #3837 (`cursor/long-term-user-simulator-4deb`), #3900..#3905 (HYGIENE-2026-275..288) — no overlap with tasks below.
