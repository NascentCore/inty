...
| CFG-PYD-10 | claimed in `cursor/agent-maintenance-tasks-83c7` | `GooglePlayConfig` | — | `google_play` | 修正 `fallback_tracks: list[str] = None` 等为 `Optional[...]` |
| CFG-PYD-11 | claimed in `cursor/agent-maintenance-tasks-83c7` | `CloudflareConfig` | — | `cloudflare` | 纯字段 |
