...
| CFG-PYD-20 | claimed | `FeaturesConfig` | — | `app.features`（预处理 dict） | `companion_transcript_compaction` 等；`__post_init__` 校验 bootstrap / context_mode；Claimed in `cursor/agent-maintenance-tasks-e9ac` |
