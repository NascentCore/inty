...
- [claimed:cursor/agent-maintenance-tasks-64e4] **STYLE-2026-11** PY_STYLE_RULES + B904: remaining `backend/ops/api/v1/evaluation.py` handlers (~50 f-string logs, ~60 bare `raise HTTPException`). Batch by router section (results/cancel, questions, agents, analytics).
