...
- 文档：`app/core/companion_harness/AGENTS.md`、`app/api/v1/endpoints/AGENTS.md`、`.cursor/skills/inty-companion-memory-db-inspect/SKILL.md` 与 Path-free registry 描述一致。
- 验证：`pytest tests/app/core/companion_harness/` + `test_chat -k companion` + `tests/experimental/test_harness_seeding_demo_workspace_setup.py` 已通过。
