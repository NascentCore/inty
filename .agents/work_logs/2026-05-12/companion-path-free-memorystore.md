...
- 文档：`app/core/companion_harness/companion/AGENTS.md`、`app/api/v1/endpoints/AGENTS.md`、`.cursor/skills/inty-companion-memory-db-inspect/SKILL.md` 与 Path-free registry 描述一致。
