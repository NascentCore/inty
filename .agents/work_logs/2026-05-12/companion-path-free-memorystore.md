...
- 文档：`app/core/agentic_kernel/companion/AGENTS.md`、`app/api/v1/endpoints/AGENTS.md`、`.cursor/skills/inty-companion-memory-db-inspect/SKILL.md` 与 Path-free registry 描述一致。
- 验证：`pytest tests/app/core/agentic_kernel/companion/` + `test_chat -k companion` + `tests/experimental/test_harness_seeding_demo_workspace_setup.py` 已通过。
