...
- Use Domain-driven design (DDD) to build logical model of a system
- Prefer using classes to abstract high-level concepts;
  do not rely on functions with lots of arguments
...
- Pydantic model fields must have description.
