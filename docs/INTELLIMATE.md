...
- Tapping or swiping on the visible character background now auto-sends a scene action message with coordinates mapped to the original background image, so the AI can understand the touched region.
