...
**See also：** [Companion 架构（WebSocket / run_turn）](ARCH.md) · [FR_WORLD_ENGINE.md](FR_WORLD_ENGINE.md) · [PRODUCT_DESIGN.md](PRODUCT_DESIGN.md)
...
4. [Pie](https://pie-project.org/) 可编程 serving 研究已收入 [ARCH.md](./ARCH.md)「推理编排与外部参考」；应用层可跟进 turn program spec、stable/volatile prompt 分层与 scratch working memory，自托管 KV 集成为远期选项。
