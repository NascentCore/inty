...
| 读出与 bundle | `app/core/companion_harness/contracts/models.py` (`load_prompt_bundle`) |
| System 注入标题 | `app/core/companion_harness/memory/memory_taxonomy.py` |
| System 组装 | `app/core/companion_harness/system_hierarchy/prompts/system_messages.py` (`build_system_messages`) |
| 路径 kind 映射 | `app/core/companion_harness/memory/memory_store_document_mapping.py` |
| 概述文档 | `app/core/companion_harness/AGENTS.md` |
