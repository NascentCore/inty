...
| 主题 | 路径 |
|------|------|
| 管线实现 | `app/core/companion_harness/memory/memory_pipeline.py` |
| 读出与 bundle | `app/core/companion_harness/companion/models.py` (`load_prompt_bundle`) |
| System 注入标题 | `app/core/companion_harness/memory/memory_taxonomy.py` |
| System 组装 | `app/core/companion_harness/companion/prompts/system_messages.py` (`build_system_messages`) |
| 路径 kind 映射 | `app/core/companion_harness/memory/memory_store_document_mapping.py` |
