...
class EmotionalState(EmotionalStateItem, Enum):
    ...
    EXCITED = ("excited", "Eager, energized; looking forward to something or stirred by the moment.")
    ...
    FLIRTATIOUS = ("flirtatious", "Playfully romantic or suggestive; showing attraction or interest.")
    CONTENT = ("content", "Satisfied with the current situation; at ease.")
    CURIOUS = ("curious", "Wanting to know or explore more; interested.")
    SURPRISED = ("surprised", "Taken aback by something unexpected; startled or amazed.")
    ...
    FRUSTRATED = ("frustrated", "Blocked or thwarted; annoyed that things are not going as desired.")
    ...
    RELIEVED = ("relieved", "Freed from worry or tension; at ease after a concern is resolved.")
    ...
    PROUD = ("proud", "Pleased with oneself or someone else; satisfied with an achievement.")
    EMBARRASSED = ("embarrassed", "Self-conscious or awkward due to a social or personal slip.")
