...
from .models import NotifyRequest, StartTaskRequest, StartTaskResponse, TaskStatusResponse
...
async def start_task(req: StartTaskRequest) -> StartTaskResponse:
    task = create_task(device_token=req.device_token, task_name=req.task_name, duration_seconds=req.duration_seconds)
...
if __name__ == "__main__":
    ...
    uvicorn.run("experimental.android_firebase_server_tasks.fastapi_server:app", host="0.0.0.0", port=8080, reload=False)
