...
Examples:
  ...
  python cli.py "A wise librarian" --export-format text --output character.txt
    ...
    parser.add_argument(
        "description",
        help="Brief description of the character to generate"
    )
    
    parser.add_argument(
        "--genre",
        default="fantasy",
        choices=["fantasy", "sci-fi", "mystery", "romance", "adventure", "slice_of_life", "horror"],
    ...
    parser.add_argument(
        "--tone",
        default="neutral",
        choices=["neutral", "serious", "humorous", "mysterious", "edgy", "cheerful", "wise"],
    ...
    parser.add_argument(
        "--image-style",
        default="realistic",
        choices=["realistic", "fantasy_art", "anime", "cyberpunk", "cartoon", "painting"],
