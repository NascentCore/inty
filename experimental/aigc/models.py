...
class CharacterGenerationRequest(BaseModel):
    ...
    brief_description: str = Field(..., description="Brief description of the character to expand upon")
    genre: Optional[str] = Field(default="fantasy", description="Genre of the character (fantasy, sci-fi, modern, etc.)")
    tone: Optional[str] = Field(default="neutral", description="Tone of the character (serious, humorous, mysterious, etc.)")
    image_style: Optional[str] = Field(default="realistic", description="Style for generated images")
    num_images: Optional[int] = Field(default=4, description="Number of images to generate")
