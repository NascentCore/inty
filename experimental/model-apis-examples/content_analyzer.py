...
Probability:"""
    ...
    def analyze_content(self, content: Union[str, str], content_type: ContentType) -> Dict[str, float]:
...
def main():
    parser = argparse.ArgumentParser(description='Analyze content for various definitions using Gemini 2.5 Flash')
    parser.add_argument('--content', required=True, help='Text content or path to image file')
    parser.add_argument('--type', choices=['text', 'image'], required=True, help='Type of content to analyze')
    parser.add_argument('--definitions', help='Path to JSON file with content definitions')
    parser.add_argument('--save-definitions', help='Path to save current definitions to JSON file')
    parser.add_argument('--add-definition', nargs=2, metavar=('LABEL', 'DEFINITION'), 
