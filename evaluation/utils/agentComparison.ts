 ...
 */
export const hasAgentChanged = (original: Agent | null, copy: Agent | null): boolean => {
 ...
 */
export const getAgentDifferences = (original: Agent | null, copy: Agent | null) => {
  ...
  try {
    ...
    return {
      hasChanges: true,
      message: 'Objects are different (detailed diff not available with isEqual)'
    };
  } catch (error) {
