...
class SystemSettings(Base):
    ...
    value_type = Column(Enum(SettingType), nullable=False, default=SettingType.STRING, comment="值类型")
    category = Column(Enum(SettingCategory), nullable=False, default=SettingCategory.GENERAL, comment="配置分类")
