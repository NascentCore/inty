...
- Shipped Android apps never sent `IMPLICIT_USER_SIGNED_ON` chat frames (control `user_signed_on` only); see [`/docs/FR_USER_SIGN_ON_GREETINGS.md`](/docs/FR_USER_SIGN_ON_GREETINGS.md) Client note.
