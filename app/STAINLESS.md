...
3. 创建的 Pull Request 触发 [Stainless 工作流](https://github.com/NascentCore/inty/actions/workflows/stainless.yaml)
   ...
   需要手动提交
4. 合并前面创建的改动 app/openapi.json 的 pull request；如：https://github.com/NascentCore/inty/pull/448
5. 更新 inty-kotlin submodule [android_app/library/inty_sdk](android_app/library/inty_sdk),
   ...
   ```
   创建 PR 并合并
6. 更新 Android app 依赖到新的 kotlin sdk 版本 `android_app/app/build.gradle.kts`；如：https://github.com/NascentCore/inty/pull/453
