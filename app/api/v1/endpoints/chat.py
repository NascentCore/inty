...
async def _run_companion_greeting_ws_turn_after_user_signed_on(
    *,
    db: AsyncSession,
    agent_id: str,
    preset_message_id: str,
    ...
    try:
        await _enqueue_companion_greeting_ws_turn_after_user_signed_on(
            db=db,
            agent_id=agent_id,
        ...
        logger.exception(
            "chat_ws user_signed_on greeting failed ws_conn_id={} agent_id={}",
            ws_conn_id,
            agent_id,
        )
    ...
    *,
    ...
    try:
        ...
        if (
            ...
            asyncio.create_task(
                _run_companion_greeting_ws_turn_after_user_signed_on(
                    db=db,
                    agent_id=agent_id,
