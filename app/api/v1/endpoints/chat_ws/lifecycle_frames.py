"""user_signed_on/out, ws_conn_dropped, and implicit greeting for companion WebSocket."""
...
from app.api.v1.endpoints.chat_ws.transport import _chat_ws_error_payload_from_http_exception
