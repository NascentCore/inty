...
@router.get(
    ...
    summary="View agent manager status",
    description="Return current agent cache usage and cleanup configuration; deprecated internal endpoint",
)
...
@router.post(
    ...
    deprecated=True,
    include_in_schema=False,
    summary="Preload popular agents (internal)",
    description="Manually warm up frequently used agents; deprecated internal maintenance endpoint",
)
...
@router.delete(
    ...
    deprecated=True,
    include_in_schema=False,
    summary="Cleanup idle agents (internal)",
    description="Force cleanup of idle agents and return number cleaned; deprecated internal endpoint",
)
