...
Holds the canonical prompt MD seed files (`AXIOM.md`, `INTY.md`, `BOOTSTRAP.md`, `TOOLS.md`,
`SIGNIFICANCE_PERCEPTION.md`) used by `app.core.companion_harness.memory.memory_store_scope.load_template_seed_text`, plus the
