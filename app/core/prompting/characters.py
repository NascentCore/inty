...
class Profile(BaseModel):
    ...
    nickname: str = Field(..., description="A 1-3 word nickname for the profile type.")
    name: str = Field(..., description="A full or partial name for the character.")
...
def output_all_profiles_to_markdown() -> str:
    ...
    markdown = "# Profiles\n\n"
    markdown += "Generated by running `python app/core/agent/characters.py`.\n\n"
