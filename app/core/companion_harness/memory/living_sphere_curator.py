...
def compact_living_sphere_batch(
    ...
    living_sphere_rel = DEFAULT_MEMORY_STORE_SCOPE_PATHS.living_sphere_md
    current_md = store.read_document(living_sphere_rel)
    requests_block = "\n".join(
    ...
    store.write_document(living_sphere_rel, new_body + "\n")
