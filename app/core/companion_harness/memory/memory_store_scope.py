...
from app.core.companion_harness.memory.file_store import read_text
...
_PROMPTS_DIR = Path(__file__).resolve().parents[1] / "system_hierarchy" / "prompts"
...
def needs_startup_profile_inquiry(store: MemoryStore) -> bool:
    ...
    """
    from app.core.companion_harness.contracts.models import load_transcript_from_store
