...
AGENTIC_COMPANION_ALLOWED_HARNESS_PREFIXES: Final[tuple[str, ...]] = (
    ...
    "app.core.companion_harness.companion.user_turn_input",
    ...
    "app.core.companion_harness.loop.config",
    "app.core.companion_harness.loop.contract",
    "app.core.companion_harness.loop.delivery_policy",
    "app.core.companion_harness.loop.output_queue",
    "app.core.companion_harness.loop.output_queue_types",
    "app.core.companion_harness.loop.loop_deliverable",
    "app.core.companion_harness.loop.runner",
