...
async def _hydrate_existing_chat_for_agent_chat(
    db: AsyncSession,
    user_id: str,
    agent_id: str,
    session_key: str,
    ...
    """Populate agent fields, optional opening message, and session cache for an existing Chat row."""
    logger.debug(
...
async def get_or_create_chat_by_agent(
    ...
    try:
        ...
        if existing_chat:
            return await _hydrate_existing_chat_for_agent_chat(
