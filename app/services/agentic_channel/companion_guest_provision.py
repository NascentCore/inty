...
a DB-enforced active companion bond; companion replacement must wait for the
product reset decision drafted in docs/companion_harness/CROSS_CHANNEL_IDENTITY_FOLLOWUPS.md.
