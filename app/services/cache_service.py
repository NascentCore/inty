...
class CacheService:
    ...
    def set_user_info(self, user_id: str, user_info: str, ttl: Optional[int] = None) -> None:
        """设置用户信息缓存"""
    ...
    def set_session_info(self, session_key: str, session_info: Dict[str, Any], ttl: Optional[int] = None) -> None:
        """设置会话信息缓存"""
    ...
    def set_agent_config(self, agent_id: str, config: Dict[str, Any], ttl: Optional[int] = None) -> None:
        """设置Agent配置缓存"""
