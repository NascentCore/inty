...
async with AsyncSessionLocal() as db:
    ...
    if user:
        print(f"User found: {user.id}, auth_type: {user.auth_type}, is_active: {user.is_active}")
...
print(f"is_active: {user.is_active}")  # 应该是 True
