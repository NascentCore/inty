...
async def find_user_by_criteria(db: AsyncSession, user_id: str = None, phone: str = None, 
                               email: str = None, readable_id: str = None) -> User:
    """根据不同条件查找用户"""
...
async def generate_long_term_token(user_id: str = None, phone: str = None, 
                                 email: str = None, readable_id: str = None, 
                                 days: int = 365):
    """生成长期有效的token"""
...
def main():
    ...
    # 生成token
    print("🔄 正在生成长期Token...")
    asyncio.run(generate_long_term_token(
