...
try:
    ...
    print("Please install with: pip install google-generativeai google-api-python-client")
    sys.exit(1)
...
class AIIndustryReporter:
    ...
    def search_recent_ai_news(self, query: str = "AI artificial intelligence developments news", 
                            days: int = 7, num_results: int = 10) -> List[Dict[str, str]]:
        """
    ...
    def summarize_with_gemini(self, search_results: List[Dict[str, str]], 
    ...
    def generate_weekly_report(self, custom_query: Optional[str] = None) -> Dict[str, any]:
        """
...
def main():
    ...
    try:
        ...
        if report["success"]:
            ...
            # Save report to file
            report_filename = f"ai_weekly_report_{datetime.now().strftime('%Y%m%d')}.json"
