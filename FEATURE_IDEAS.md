...
- 记忆触发：对话前可上传/输入“记忆卡片”（地点、照片描述、关键词、片段对白），角色在开场与关键节点引用这些内容，强化“熟悉感”。
- 记忆瞬间（Memory Moment）：在对话中由用户手动标记或由系统识别里程碑（和好、告白、第一次一起做某事、纪念日），生成一张“记忆瞬间卡”（摘要 + 关键词 + 可选封面），作为后续二次创作与召回的锚点。
- 收藏与分享：角色与其“记忆瞬间卡”可保存到「回忆专辑」，支持导出“记忆档案卡”、分享卡片或邀请好友体验同款（默认脱敏）。
