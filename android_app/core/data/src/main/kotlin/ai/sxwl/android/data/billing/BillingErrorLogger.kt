...
object BillingErrorLogger {
    ...
    private fun handleBillingError(
        ...
        LogUtils.e("Billing BillingErrorLogger - $errorMessage")

        // 记录详细错误信息
        LogUtils.i("Billing BillingErrorLogger - 详细错误信息: ${billingResult.debugMessage}")
        LogUtils.i("Billing BillingErrorLogger - 错误响应码: ${billingResult.responseCode}")
    ...
    private fun provideSolutionSuggestions(billingResult: BillingResult, context: Context?) {
        ...
        LogUtils.i("Billing BillingErrorLogger - 解决建议:")
        suggestions.forEach { suggestion -> LogUtils.i("Billing BillingErrorLogger - $suggestion") }
    }
}
