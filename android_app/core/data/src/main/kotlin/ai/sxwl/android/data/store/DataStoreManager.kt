...
object DataStoreManager {
    ...
    /**
     * DataStore 实例注册表，key 为模块名称（null 表示全局 DataStore），value 为对应的 DataStore 实例
    ...
    suspend fun clearAll() {
        dataStoreRegistry.forEach { store ->
            store.value.clear()
        }
    }
}
 ...
 * @return DataStore 实例，可用于存储和读取 Preferences 数据
 */
fun dataStore(name: String? = null): DataStore<Preferences> {
    return DataStoreManager.getOrCreateDataStore(Utils.getApp(), name)
}
 ...
 */
suspend fun <T> DataStore<Preferences>.put(key: Preferences.Key<T>, value: T) = edit { it[key] = value }
 ...
 */
fun <T> DataStore<Preferences>.get(key: Preferences.Key<T>) = data.map { it[key] }.distinctUntilChanged()
 ...
 * @return Flow<Int?>，数据流
 */
fun DataStore<Preferences>.getInt(key: String) = data.map { it[intPreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putInt(key: String, value: Int) = edit { it[intPreferencesKey(key)] = value }
 ...
 */
fun DataStore<Preferences>.getString(key: String) = data.map { it[stringPreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putString(key: String, value: String) = edit { it[stringPreferencesKey(key)] = value }
 ...
 */
fun DataStore<Preferences>.getLong(key: String) = data.map { it[longPreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putLong(key: String, value: Long) = edit { it[longPreferencesKey(key)] = value }
 ...
 */
fun DataStore<Preferences>.getFloat(key: String) = data.map { it[floatPreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putFloat(key: String, value: Float) = edit { it[floatPreferencesKey(key)] = value }
 ...
 */
fun DataStore<Preferences>.getDouble(key: String) = data.map { it[doublePreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putDouble(key: String, value: Double) = edit { it[doublePreferencesKey(key)] = value }
 ...
 */
fun DataStore<Preferences>.getBoolean(key: String) = data.map { it[booleanPreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putBoolean(key: String, value: Boolean) = edit { it[booleanPreferencesKey(key)] = value }
 ...
 */
fun DataStore<Preferences>.getStringSet(key: String) = data.map { it[stringSetPreferencesKey(key)] }.distinctUntilChanged()
 ...
 */
suspend fun DataStore<Preferences>.putStringSet(key: String, value: Set<String>) = edit { it[stringSetPreferencesKey(key)] = value }