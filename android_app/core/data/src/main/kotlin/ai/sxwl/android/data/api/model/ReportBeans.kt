...
enum class ReportReasonCode {
    @Json(name = "SENSITIVE_CONTENT")
    SENSITIVE_CONTENT,

    @Json(name = "MISINFORMATION")
    MISINFORMATION,

    @Json(name = "FRAUD_SCAMS")
    FRAUD_SCAMS,

    @Json(name = "PRIVACY_VIOLATION")
    PRIVACY_VIOLATION,

    @Json(name = "HARMFUL_MINORS")
    HARMFUL_MINORS,

    @Json(name = "IP_VIOLATION")
    IP_VIOLATION,

    @Json(name = "OTHER")
    OTHER,

    @Json(name = "CHAT_NOT_NATURAL")
    CHAT_NOT_NATURAL,

    @Json(name = "CHARACTER_MISMATCH")
    CHARACTER_MISMATCH,

    @Json(name = "APP_SLOW")
    APP_SLOW,

    @Json(name = "FEATURE_HARD_TO_FIND")
    FEATURE_HARD_TO_FIND,

    @Json(name = "UI_INCONVENIENT")
    UI_INCONVENIENT,
...
@JsonClass(generateAdapter = true)
data class ReportCreateApiResponse(
    val code: Int? = null,
