...
data class SubscriptionPlansResponse(
    ...
    val currentSubscription: CurrentSubscription? =
        null, // 当前用户的订阅信息，null，表示没有订阅，或者已过期。结合has_ever_subscribed判断
...
data class SubscriptionPlan(
    ...
    @Json(name = "discount_rate") val discountRate: Double? = null,
    val features: Map<String, Any>? = null, // 简化为Map，因为实际结构可能复杂
    @Json(name = "chat_limit_per_day") val chatLimitPerDay: Int? = null,
    @Json(name = "agent_creation_limit") val agentCreationLimit: Int? = null,
...
data class CurrentSubscription(
    ...
    @Json(name = "google_play_purchase_token") val googlePlayPurchaseToken: String? = null,
    @Json(name = "google_play_order_id") val googlePlayOrderId: String? = null,
    @Json(name = "google_play_subscription_id") val googlePlaySubscriptionId: String? = null,
...
// null 认为未订阅
    ...
    @Json(name = "end_date") val endDate: String? = null, // 时间格式是服务端数据样式2025-09-01T06:03:15.383000Z
    @Json(name = "trial_end_date") val trialEndDate: String? = null,
    @Json(name = "auto_renew") val autoRenew: Boolean? = null,
    @Json(name = "extra_data") val extraData: Map<String, Any>? = null,
    val id: String? = null,
