...
object BusinessErrorCodes {
    ...
    /** 音乐生成次数超限制 */
    const val MUSIC_GENERATION_LIMIT_REACHED_CODE = 10001009
    const val MUSIC_GENERATION_LIMIT_REACHED_ERROR_CODE = "MUSIC_GENERATION_LIMIT_REACHED"
    const val MUSIC_GENERATION_LIMIT_REACHED_MESSAGE = "Music generation limit reached"
    ...
    /** 业务错误消息映射（code -> message），与后端错误码保持一致 */
    val BUSINESS_ERROR_MESSAGES =
        mapOf(
            ...
            MUSIC_GENERATION_LIMIT_REACHED_CODE to MUSIC_GENERATION_LIMIT_REACHED_MESSAGE,
