...
class ChatRemoteDataSource {
    ...
    suspend fun getMessages(
        ...
        return try {
            LogUtils.i("ChatRemoteDataSource.getMessages: agentId=$agentId, pageSize=$pageSize, offset=$offset")
    ...
    suspend fun sendMessage(agentId: String, messages: List<MsgInfo>): HttpResult<SendMsgResponse> {
        return try {
            LogUtils.i("ChatRemoteDataSource.sendMessage: agentId=$agentId, messagesCount=${messages.size}")
