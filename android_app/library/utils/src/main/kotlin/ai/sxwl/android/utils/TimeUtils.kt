...
object TimeUtils {
    ...
    val nowDateTimeStr: String
        get() = format(nowMillis, DATE_TIME_PATTERN)

    /** 当前日期字符串 (yyyy-MM-dd) */
    val nowDateStr: String
        get() = format(nowMillis, DATE_PATTERN)

    /** 当前时间字符串 (HH:mm:ss) */
    val nowTimeStr: String
        get() = format(nowMillis, TIME_PATTERN)

    /** 当前星期 */
    val nowWeek: String
        get() = format(nowMillis, WEEK_PATTERN)
    ...
    val yesterdayDate: String
        get() = format(nowMillis - ONE_DAY_MILLIS, DATE_PATTERN)
    ...
    val afterTomorrowDate: String
        get() = format(nowMillis + 2 * ONE_DAY_MILLIS, DATE_PATTERN)
