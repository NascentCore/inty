  ...
  fun onPurchasesUpdated(billingResult: BillingResult, purchases: MutableList<Purchase>?) {
    ...
    when (billingResult.responseCode) {
      ...
      BillingClient.BillingResponseCode.ITEM_ALREADY_OWNED -> {
        ...
        eventScope.launch {
          eventFlow.emit(
              BillingEvent.PurchaseFailed(billingResult.responseCode, "Item already owned")
          )
        }
      }
      ...
      BillingClient.BillingResponseCode.ITEM_NOT_OWNED -> {
        ...
        eventScope.launch {
          eventFlow.emit(BillingEvent.PurchaseFailed(billingResult.responseCode, "Item not owned"))
        }
      }
      ...
      BillingClient.BillingResponseCode.DEVELOPER_ERROR -> {
        ...
        eventScope.launch {
          eventFlow.emit(BillingEvent.PurchaseFailed(billingResult.responseCode, "Developer error"))
        }
      }
      ...
      BillingClient.BillingResponseCode.SERVICE_UNAVAILABLE -> {
        ...
        eventScope.launch {
          eventFlow.emit(
              BillingEvent.PurchaseFailed(billingResult.responseCode, "Service unavailable")
          )
        }
      }
      ...
      BillingClient.BillingResponseCode.NETWORK_ERROR -> {
        ...
        eventScope.launch {
          eventFlow.emit(BillingEvent.PurchaseFailed(billingResult.responseCode, "Network error"))
        }
      }
      ...
      BillingClient.BillingResponseCode.FEATURE_NOT_SUPPORTED -> {
        ...
        eventScope.launch {
          eventFlow.emit(
              BillingEvent.PurchaseFailed(billingResult.responseCode, "Feature not supported")
          )
        }
      }
      ...
      BillingClient.BillingResponseCode.ERROR -> {
        ...
        eventScope.launch {
          eventFlow.emit(BillingEvent.PurchaseFailed(billingResult.responseCode, "General error"))
        }
      }
  ...
  private fun launchBillingFlowInternal(activity: Activity, productId: String) {
    ...
    billingClient.querySkuDetailsAsync(params) { billingResult, skuDetailsList ->
      ...
      when (billingResult.responseCode) {
        ...
        BillingClient.BillingResponseCode.SERVICE_UNAVAILABLE -> {
          showError(activity, "Service unavailable: Google Play services temporarily unavailable")
          EasyLog.log("BillingRepository BillingPurchaseManager ❌ 服务不可用: Google Play 服务暂时不可用")
        }

        BillingClient.BillingResponseCode.BILLING_UNAVAILABLE -> {
          showError(activity, "Billing unavailable: Device does not support Google Play billing")
        ...
        BillingClient.BillingResponseCode.NETWORK_ERROR -> {
          ...
          showError(activity, "Query product details failed: ${billingResult.debugMessage}")
          EasyLog.log(
