...
object AgentService {
            ...
            val response = IntyNetworkManager.getClient()
                .api().v1().ai().agents().recommend(
                    com.inty.api.models.api.v1.ai.agents.AgentRecommendParams.builder()
                        ...
                        .sort(
                            when (sort) {
                                "random" -> com.inty.api.models.api.v1.ai.agents.AgentRecommendParams.Sort.RANDOM
                                "created_asc" -> com.inty.api.models.api.v1.ai.agents.AgentRecommendParams.Sort.CREATED_ASC
                                "created_desc" -> com.inty.api.models.api.v1.ai.agents.AgentRecommendParams.Sort.CREATED_DESC
                                else -> com.inty.api.models.api.v1.ai.agents.AgentRecommendParams.Sort.RANDOM
                            }
                        )
                        .sortSeed(sortSeed)
                        .build()
    ...
    /**
     * 创建智能体
     * 替换: IAgentApi.createAgent()
     * 注意: 当前 IntySDK 没有直接的 create agent API
     */
    ...
    /**
     * 更新智能体
     * 替换: IAgentApi.updateAgent()
     * 注意: 当前 IntySDK 没有直接的 update agent API
     */
