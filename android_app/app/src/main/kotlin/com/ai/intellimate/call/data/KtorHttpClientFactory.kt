...
/**
 * Ktor HttpClient工厂
 * 基于UnifiedOkHttpClient创建Ktor HttpClient，复用统一的网络配置和拦截器
...
object KtorHttpClientFactory {
    ...
    /**
     * 获取Ktor HttpClient单例实例
     * 使用OkHttp引擎，复用UnifiedOkHttpClient的配置
     * 
     * @return HttpClient单例实例
     */
    fun getInstance(): HttpClient {
        return instance ?: synchronized(this) {
            instance ?: createHttpClient().also { instance = it }
        }
    }
    ...
    /**
     * 创建新的HttpClient实例（不推荐使用，除非有特殊需求）
     * 建议使用getInstance()获取单例
     * 
