...
# ### 由 Alembic 自动生成的命令 - 请调整！###
    ...
    op.create_table('user_notifications',
        ...
        sa.Column('dynamic_params', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_index('ix_user_notifications_template_id', 'user_notifications', ['template_id'], unique=False)
    op.create_index('ix_user_notifications_is_read', 'user_notifications', ['is_read'], unique=False)
    op.create_index('ix_user_notifications_deleted_at', 'user_notifications', ['deleted_at'], 
                    postgresql_where=sa.text('deleted_at IS NOT NULL'), unique=False)
