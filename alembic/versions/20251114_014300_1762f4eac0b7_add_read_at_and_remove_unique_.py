...
def upgrade() -> None:
    ...
    op.drop_index("uq_push_notification_user_stage_no_chat", table_name="push_notification_history")
...
def downgrade() -> None:
    ...
    op.drop_index("ix_push_notification_chat_stage_unread", table_name="push_notification_history")
    op.drop_index("ix_push_notification_read_at", table_name="push_notification_history")
