...
＃3。更新列类型
    op.execute("ALTER TABLE subscription_plans ALTER COLUMN plan_type TYPE subscriptionplantype_temp USING plan_type::text::subscriptionplantype_temp")
＃4。删除旧枚举
