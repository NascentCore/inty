...
- **`companion_id`**：HTTP/API/WebSocket 里的 **`agent_id` 原样**（见 `/app/core/companion_harness/AGENTS.md`）。
...
- 持久化约定：**`/app/core/companion_harness/AGENTS.md`**「持久化与数据表」「进程内 registry」小节。
