...
def test_get_mode_output_format_prompt_by_id():
    ...
    purity_output_format_prompt = get_mode_output_format_prompt_by_id("purity_mode_0725")
    ...
    assert "All dialogues must be enclosed in quotation marks" in flirting_output_format_prompt
