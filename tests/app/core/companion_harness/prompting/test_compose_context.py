...
def test_user_chat_bootstrap_compose_context_pins_bootstrap_phase(tmp_path) -> None:
    """``USER_CHAT_BOOTSTRAP`` composes bootstrap slices even when context is settled."""
