...
from app.core.companion_harness.contracts.models import InnerTickMode
...
@patch(
    "app.core.companion_harness.llm.llm_chat_runtime.companion_turn_langsmith_parent_enabled",
    return_value=False,
)
