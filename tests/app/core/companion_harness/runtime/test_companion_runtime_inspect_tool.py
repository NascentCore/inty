...
from app.core.companion_harness.runtime import runtime_inspect_context as ric
from app.core.companion_harness.llm.llm_chat_runtime import tool_path_chat_completion_kwargs
from app.core.companion_harness.llm.llm_client import CompanionLLMClient, CompanionLLMConfig
...
from app.core.companion_harness.contracts.models import ContextMeta, InnerTickMode
...
def test_build_system_prompt_tools_contract_mentions_inspect() -> None:
    from app.core.companion_harness.contracts.models import PromptBundle
...
def test_run_turn_foreground_dual_llm_sets_runtime_inspect(
    ...
    from app.core.companion_harness.runtime.turn import run_turn
