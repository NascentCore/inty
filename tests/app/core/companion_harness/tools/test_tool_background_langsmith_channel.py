...
def test_initial_tool_bg_completion_sync_receives_telegram_channel() -> None:
    ...
    assert extra["name"] == LangsmithLlmSource.TOOL_BACKGROUND_INITIAL.value
...
async def test_run_background_tool_loop_continue_sync_receives_telegram_channel(
    ...
    assert initial_extra["name"] == LangsmithLlmSource.TOOL_BACKGROUND_INITIAL.value
    ...
    assert continue_extra["name"] == LangsmithLlmSource.TOOL_BACKGROUND_CONTINUE.value
