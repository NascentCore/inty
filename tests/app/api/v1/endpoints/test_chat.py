...
from app.services.chat_websocket import handlers as chat_ws_handlers
from app.services.chat_websocket import transport as chat_ws_transport
from app.services.chat_websocket import turn as chat_ws_turn
...
def _setup_companion_ws_chat_test_env(
    ...
    *,
    ...
    monkeypatch.setattr(chat_ws_handlers, "_get_current_user_from_websocket", fake_ws_user)
...
def test_chat_websocket_reuses_connection_for_multiple_agents(
    ...
    monkeypatch.setattr(chat_ws_handlers, "_get_current_user_from_websocket", fake_ws_user)
    monkeypatch.setattr(
        chat_ws_handlers, "_agent_chat_ws_completions_impl", fake_agent_chat_ws_completions
    )
...
def test_chat_websocket_idle_timeout_reads_config(
    ...
    real_wait_for = chat_ws_handlers.asyncio.wait_for
    ...
    monkeypatch.setattr(chat_ws_handlers.asyncio, "wait_for", fake_wait_for)
