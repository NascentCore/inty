...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(length=255), nullable=False, comment="评测会话名称"
        ),
        ...
        sa.Column(
            "scoring_model", sa.String(length=255), nullable=False, comment="评分模型"
        ),
        ...
        sa.Column(
            "completed_tests", sa.Integer(), nullable=False, comment="已完成测试数量"
        ),
    ...
    op.create_index(
        op.f("ix_evaluation_sessions_id"), "evaluation_sessions", ["id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "default_scoring_criteria", sa.Text(), nullable=True, comment="默认评分标准"
        ),
        sa.Column(
            "recommended_models",
            postgresql.JSON(astext_type=sa.Text()),
    ...
    op.create_index(
        op.f("ix_evaluation_templates_id"), "evaluation_templates", ["id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_evaluation_interactions_id"), table_name="evaluation_interactions"
    )
