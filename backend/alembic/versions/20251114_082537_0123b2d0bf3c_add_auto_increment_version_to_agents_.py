...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_push_notification_history_sent_at"),
        table_name="push_notification_history",
    )
    op.create_index(
        "ix_push_notification_agent_id",
        "push_notification_history",
        ["agent_id"],
        unique=False,
    )
    op.create_index(
        "ix_push_notification_sent_at",
        "push_notification_history",
        ["sent_at"],
        unique=False,
    )
    op.create_index(
        "ix_push_notification_user_id",
        "push_notification_history",
        ["user_id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        "ix_push_notification_user_id", table_name="push_notification_history"
    )
    op.drop_index(
        "ix_push_notification_sent_at", table_name="push_notification_history"
    )
    op.drop_index(
        "ix_push_notification_agent_id", table_name="push_notification_history"
    )
    op.create_index(
        op.f("ix_push_notification_history_sent_at"),
        "push_notification_history",
