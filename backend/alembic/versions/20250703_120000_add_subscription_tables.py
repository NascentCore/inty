...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('plan_type', sa.Enum('MONTHLY', 'YEARLY', name='subscriptionplantype'), nullable=False, comment='计划类型'),
        sa.Column('price', sa.Float(), nullable=False, comment='价格'),
        sa.Column('currency', sa.String(), nullable=True, comment='货币'),
        sa.Column('google_play_product_id', sa.String(), nullable=False, comment='Google Play产品ID'),
        sa.Column('features', sa.JSON(), nullable=True, comment='功能权益配置'),
        sa.Column('chat_limit_per_day', sa.Integer(), nullable=True, comment='每日聊天次数限制，-1为无限制'),
        sa.Column('agent_creation_limit', sa.Integer(), nullable=True, comment='Agent创建数量限制'),
    ...
    op.create_table(
        ...
        sa.Column('google_play_purchase_token', sa.String(), nullable=True, comment='Google Play购买令牌'),
        sa.Column('google_play_order_id', sa.String(), nullable=True, comment='Google Play订单ID'),
        sa.Column('google_play_subscription_id', sa.String(), nullable=True, comment='Google Play订阅ID'),
        sa.Column('status', sa.Enum('ACTIVE', 'EXPIRED', 'CANCELLED', 'PENDING', 'REFUNDED', 'GRACE_PERIOD', 'PAUSED', name='subscriptionstatus'), nullable=True, comment='订阅状态'),
    ...
    op.create_table(
        ...
        sa.Column('user_id', sa.String(), nullable=False, comment='用户ID'),
        sa.Column('transaction_type', sa.Enum('PURCHASE', 'RENEWAL', 'UPGRADE', 'DOWNGRADE', 'REFUND', 'CANCEL', name='transactiontype'), nullable=False, comment='交易类型'),
        sa.Column('amount', sa.Float(), nullable=False, comment='交易金额'),
        sa.Column('currency', sa.String(), nullable=True, comment='货币'),
        sa.Column('google_play_purchase_token', sa.String(), nullable=True, comment='Google Play购买令牌'),
        sa.Column('google_play_order_id', sa.String(), nullable=True, comment='Google Play订单ID'),
        sa.Column('google_play_transaction_id', sa.String(), nullable=True, comment='Google Play交易ID'),
    ...
    op.create_table(
        ...
        sa.Column('usage_type', sa.String(), nullable=False, comment='使用类型（如chat、agent_creation等）'),
        sa.Column('usage_date', sa.DateTime(timezone=True), nullable=False, comment='使用日期'),
