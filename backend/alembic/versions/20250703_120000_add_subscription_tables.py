...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "sort_order", sa.Integer(), nullable=True, comment="排序顺序"
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "auto_renew", sa.Boolean(), nullable=True, comment="是否自动续费"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "subscription_id", sa.String(), nullable=False, comment="订阅记录ID"
        ),
        sa.Column("user_id", sa.String(), nullable=False, comment="用户ID"),
        sa.Column(
            "transaction_type",
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.String(), nullable=False, comment="用户ID"),
        sa.Column(
            "subscription_id", sa.String(), nullable=True, comment="订阅记录ID"
        ),
        sa.Column(
            "usage_type",
            sa.String(),
        ...
        sa.Column(
            "usage_count", sa.Integer(), nullable=True, comment="使用次数"
        ),
        sa.Column("extra_data", sa.JSON(), nullable=True, comment="额外元数据"),
        sa.Column(
            "created_at",
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_subscription_usage_id"), table_name="subscription_usage"
    )
    ...
    op.drop_index(
        op.f("ix_user_subscriptions_id"), table_name="user_subscriptions"
    )
