...
def upgrade() -> None:
    ...
    sendertype = postgresql.ENUM(
        "USER", "AI", name="sendertype", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "settings", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        ...
        sa.Column(
            "photos", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "ix_chat_settings_id", "chat_settings", ["id"], unique=False
    )
