...
def upgrade() -> None:
    ...
    if "opening_audio_url" not in columns:
        op.add_column(
            "agents", sa.Column("opening_audio_url", sa.String(), nullable=True)
        )
        print("Added opening_audio_url column to agents table")
    else:
        print(
            "opening_audio_url column already exists in agents table, skipping"
        )
...
def downgrade() -> None:
    ...
    if "opening_audio_url" in columns:
        ...
        print(
            "opening_audio_url column does not exist in agents table, skipping"
        )
