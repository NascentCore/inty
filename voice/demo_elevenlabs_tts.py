...
voice_settings = VoiceSettings(
    # Lower value means more dynamic and randomness in voices.
    # Higher value results into monotonous voices.
    stability=0.5,
    # Style exaggeration compared to the original speaker in voic clone.
    style=1.0,
    # Higher is faster.
    speed=1.2,
)
